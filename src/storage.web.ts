...
export function blankPage(template: PageTemplate = "line", templateSpacing: TemplateSpacing = "medium"): Page { return { id: makeId(), drawingData: "", template, templateSpacing, updatedAt: now() }; }
export function newNotebook(title = "제목 없는 노트", template: PageTemplate = "line", templateSpacing: TemplateSpacing = "medium"): Notebook { const t=now();return{id:makeId(),title,folder:"내 노트",tags:[],favorite:false,createdAt:t,updatedAt:t,pageOrderUpdatedAt:t,pages:[blankPage(template,templateSpacing)]}; }

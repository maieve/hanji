...
export type UiPreferences={leftHanded:boolean;fingerDrawingEnabled:boolean;pageTurnHaptics:boolean;defaultTemplate:PageTemplate;autoDarkInk:boolean;backupRetention:number;backupIntervalMinutes:number;newPagePlacement:'after-current'|'end';librarySort:LibrarySort;libraryView:LibraryViewMode};
export const defaultUiPreferences:UiPreferences={leftHanded:false,fingerDrawingEnabled:false,pageTurnHaptics:true,defaultTemplate:'line',autoDarkInk:true,backupRetention:5,backupIntervalMinutes:30,newPagePlacement:'after-current',librarySort:'updated',libraryView:'grid'};

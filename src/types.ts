...
export type Page={id:string;drawingData:string;template:'plain'|'line'|'grid'|'dot'|'cornell'|'planner'|'dark';updatedAt:string;pdfUri?:string;pdfName?:string;ocrText?:string;ocrWords?:OcrWord[]};

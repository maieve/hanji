...
export type Page={id:string;drawingData:string;template:PageTemplate;templateSpacing?:TemplateSpacing;backgroundColor?:string;backgroundOpacity?:number;rotation?:PageRotation;customTemplateUri?:string;updatedAt:string;bookmarked?:boolean;elements?:PageElement[];pdfUri?:string;pdfName?:string;pdfPageIndex?:number;ocrText?:string;ocrWords?:OcrWord[]};

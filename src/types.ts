...
export type Notebook={id:string;title:string;folder:string;tags:string[];favorite:boolean;locked?:boolean;createdAt:string;updatedAt:string;lastOpenedAt?:string;viewMode?:'page'|'continuous';pages:Page[];deletedPages?:Record<string,string>;audioSessions?:AudioSession[];flashcards?:Flashcard[];conflictOf?:string;conflictSignature?:string};

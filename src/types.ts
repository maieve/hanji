...
export type ToolSpec={kind:ToolKind;color:string;width:number;opacity?:number;eraserMode?:'vector'|'bitmap'|'fixedWidthBitmap';eraserAutoReturn?:boolean;rulerActive?:boolean;shapeKind?:ShapeKind;shapeLineStyle?:'solid'|'dashed';shapeHoldRequired?:boolean;scratchEnabled?:boolean;circleToLasso?:boolean;markerStraightLine?:boolean};

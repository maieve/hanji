...
export type Page={id:string;drawingData:string;template:'plain'|'line'|'grid'|'dot'|'cornell'|'planner'|'dark';updatedAt:string;bookmarked?:boolean;pdfUri?:string;pdfName?:string;ocrText?:string;ocrWords?:OcrWord[]};
